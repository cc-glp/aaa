    ...
    function loginU() {
        ...
        if (!(getCookie('user') == '')) {
            $('.buy').click(function () {
                ...
                console.log(index)
                // var shopjiage=$(this).siblings('.shop_info_jiage').html()
                // console.log(shopjiage)
                ...
                // var shop_num=parseInt($(this).siblings('.shop_info_xiaoliao').children('span').text())
                // setCookie("shop_nun"+index,shop_num)
